...
- [React](https://react.dev/) 19.2.3 with [React Compiler](https://react.dev/learn/react-compiler)
- [React Native](https://reactnative.dev/) 0.86.3 with [New Architecture](https://reactnative.dev/docs/new-architecture-intro)
- [Expo SDK](https://docs.expo.dev/) 57.0.24
- [TypeScript](https://www.typescriptlang.org/) 5+

### Navigation & Routing

- [Expo Router](https://docs.expo.dev/router/introduction/) 57.0.22 (typed routes enabled)

### UI & Styling

- [HeroUI Native](https://v3.heroui.com/docs/native/getting-started) 1.0.10 (30+ components)
