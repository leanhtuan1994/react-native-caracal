...
Caracal uses [HeroUI Native](https://v3.heroui.com/native) (v1.0.10) as the primary UI component library, providing 30+ production-ready components with built-in accessibility, theming, and styling.
...
This guide tracks the packages pinned in the root `package.json`. See [Libraries Used](/docs#libraries-used) for the current framework and UI package versions.
